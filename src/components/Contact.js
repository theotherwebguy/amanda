              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+27 71 162 8293</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content"><a style={{color: '#fff'}} href="mailto:amandathabekhulu@gmail.com" target="_blank">amandathabekhulu@gmail.com</a></span>
                  </h6>
                </li>
                {/* <li>
                  <h6 className="font-weight-600">
